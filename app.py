...
user_menu = st.sidebar.radio(
    ...
    ('Medal Tally', 'Overall Analysis', 'Country-wise Analysis',
     'Athlete wise Analysis', 'Medal Prediction')
)
...
if user_menu == 'Medal Prediction':
    # st.title("Medal Prediction W/ Linear Regression")
    # st.markdown("Medal Prediction")
    st.header("Medal Prediction: Linear Regression")
    data = pd.read_csv("Predictions-2020-copy.csv")  # path folder of the data file
    st.write(data)
    ...
    columns=["Gold Predicted","Silver Predicted","Bronze Predicted"])
